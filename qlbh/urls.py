...
from . import views
from .views import DoanhThuCuaHangView, NhanVienView, SanPhamView, KhachHangView, DoanhSoKhachHangView,TimHoaDonMaxMinView, SanPhamMuaNhieuNhatView, SanPhamMuaItNhatView,TimKhachHangCoDoanhSoCaoNhat
urlpatterns = [
